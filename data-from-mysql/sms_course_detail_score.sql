...
--
-- Table structure for table `course_detail_score`
--

DROP TABLE IF EXISTS `course_detail_score`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `course_detail_score` (
...
--
-- Dumping data for table `course_detail_score`
--

LOCK TABLES `course_detail_score` WRITE;
/*!40000 ALTER TABLE `course_detail_score` DISABLE KEYS */;
INSERT INTO `course_detail_score` VALUES (1,73),(2,73),(3,73),(4,73),(5,91),(6,82),(7,89);
/*!40000 ALTER TABLE `course_detail_score` ENABLE KEYS */;
UNLOCK TABLES;
